<template>
  <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
    <div class="flex items-center flex-shrink-0 text-white mr-6">
      <svg
      class="fill-current h-8 w-8 mr-6"
      version="1.1"
    ...
    <span class="font-semibold text-xl tracking-tight">News Rack</span>
  </div>
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <ul class="text-lg lg:flex-grow">
      ...
      <nuxt-link to="/News/dashboard" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">dashboard</nuxt-link>
      <nuxt-link to="/About/about" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">About</nuxt-link>
    </ul>
  </div>
  </nav>
</template>
